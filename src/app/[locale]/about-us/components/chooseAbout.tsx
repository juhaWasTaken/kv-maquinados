...
const reasons = [
    {
        title: "reasons.r1.title",
        description: "reasons.r1.text"
    },
    {
        title: "reasons.r2.title",
        description: "reasons.r2.text"
    },
    {
        title: "reasons.r3.title",
        description: "reasons.r3.text"
    },
    {
        title: "reasons.r4.title",
        description: "reasons.r4.text"
    }
]
            ...
            <div className='flex flex-col lg:flex-row'>
                <div className='relative h-[220px] md:h-[400px] w-full lg:min-h-[480px] lg:w-[40%] order-last lg:order-1'>
                    ...
                    <div className='absolute left-0 bottom-0 bg-white/85 flex flex-col px-5 pt-3 pb-[15px] md:px-6 md:pt-[18px] md:pb-5 w-fit mr-4 md:mr-0 text-center'>
                        ...
                        <p className='text-[#535353] text-xs md:text-[13px] lg:text-sm uppercase tracking-widest font-semibold'>{t('numProjectsTxt')}</p>
                    </div>
                </div>

                <div className='mb-8 lg:w-[60%] lg:ml-[48px] lg:order-2'>
                    <p className='text-[#13213C] uppercase tracking-widest text-xs md:text-sm lg:text-base font-semibold mb-5'>{t('section')}</p>
                    <h2 className={`${rajdhani.className} text-[#13213C] text-[31px] md:text-[38px] lg:text-[46px] mb-5 leading-tight `}>{t('title')}</h2>
                    <p className='text-[#535353] text-sm md:text-[15px] lg:text-base'>{t('text')}</p>
