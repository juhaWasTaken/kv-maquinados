          ...
          <aside className="flex flex-col gap-8 lg:w-[31.66%]">
            <section className="p-8 h-fit bg-white">
              ...
              <ul className="grid md:grid-cols-2 gap-2">
                ...
                <li className="mb-2">
                  <Link className="text-sm md:text-[0.938rem] lg:text-base text-[#535353] hover:text-[#ff9302]" href="/services/service5">{t('service-6.title')}</Link>
                </li>
            ...
            <section className="relative p-8 w-full h-fit lg:w-full lg:h-[232px]">
              ...
              <div className="relative z-20 flex flex-col">
                <Link href='/contact' className={`${rajdhani.className} text-white text-[1.375rem] md:text-[1.563rem] lg:text-[1.75rem] mb-4`}>
                {t('contact')}
                </Link>
