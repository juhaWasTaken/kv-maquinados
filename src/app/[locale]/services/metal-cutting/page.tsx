      ...
      <section className="bg-[#f5f5f5] pt-20">
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-12 max-w-[1280px] mx-auto pb-20 px-4 md:px-5 lg:px-4">
          <main className="lg:w-[68%] bg-white p-6 md:p-9 lg:p-12">
            ...
            <p className="text-sm md:text-[0.938rem] lg:text-base text-[#535353] mb-4">{t('service-5.text-1')}</p>
            <p className="text-sm md:text-[0.938rem] lg:text-base text-[#535353] mb-5">{t('service-5.text-2')}</p>
              ...
              <div>
                <ul>
                  <li className="text-sm md:text-[0.938rem] lg:text-base mb-3 flex items-start" >
                    ...
                    {t('service-5.includes.item-1')}
                  </li>
                  <li className="text-sm md:text-[0.938rem] lg:text-base mb-3 flex items-start" >
                    <Plus size={20} color="#ff9302" className="mr-2" strokeWidth="3" />
                    {t('service-5.includes.item-2')}
                  </li>
                  <li className="text-sm md:text-[0.938rem] lg:text-base mb-3 flex items-start" >
                    <Plus size={20} color="#ff9302" className="mr-2" strokeWidth="3" />
                    {t('service-5.includes.item-3')}
                  </li>
                  <li className="text-sm md:text-[0.938rem] lg:text-base mb-3 flex items-start" >
                    <Plus size={20} color="#ff9302" className="mr-2" strokeWidth="3" />
                    {t('service-5.includes.item-4')}
                  </li>
                </ul>
              </div>
              <div>
                <ul>
                  <li className="text-sm md:text-[0.938rem] lg:text-base mb-3 flex items-start" >
                    <Plus size={20} color="#ff9302" className="mr-2" strokeWidth="3" />
                    {t('service-5.includes.item-5')}
                  </li>
                  <li className="text-sm md:text-[0.938rem] lg:text-base mb-3 flex items-start" >
                    <Plus size={20} color="#ff9302" className="mr-2" strokeWidth="3" />
                    {t('service-5.includes.item-6')}
                  </li>
                  <li className="text-sm md:text-[0.938rem] lg:text-base mb-3 flex items-start" >
                    <Plus size={20} color="#ff9302" className="mr-2" strokeWidth="3" />
                    {t('service-5.includes.item-7')}
                  </li>
                  <li className="text-sm md:text-[0.938rem] lg:text-base mb-3 flex items-start" >
                    <Plus size={20} color="#ff9302" className="mr-2" strokeWidth="3" />
                    {t('service-5.includes.item-8')}
                  </li>
                </ul>
              </div>
            </div>
