...
const projects = [
    {
        ...
        type: 'projects.project-1.type',
    },
    {
        img: factory7,
        name: 'projects.project-2.name',
        type: 'projects.project-2.type',
    },
    {
        img: factory2,
        name: 'projects.project-3.name',
        type: 'projects.project-3.type',
    },
    {
        img: factory9,
        name: 'projects.project-4.name',
        type: 'projects.project-4.type',
    },
    {
        img: factory5,
        name: 'projects.project-5.name',
        type: 'projects.project-5.type',
    },
    {
        img: factory,
        name: 'projects.project-6.name',
        type: 'projects.project-6.type',
    },
    {
        img: factory3,
        name: 'projects.project-7.name',
        type: 'projects.project-7.type',
    },
    {
        img: factory8,
        name: 'projects.project-8.name',
        type: 'projects.project-8.type',
    },
    {
        img: factory4,
        name: 'projects.project-9.name',
        type: 'projects.project-9.type',
    }
]
        ...
        <section className={`${className} max-w-[1280px] mx-auto px-5`}>
            <div className="flex flex-col mb-10 lg:flex-row lg:items-center lg:justify-between gap-5 lg:gap-10">
                <div className="flex flex-col gap-4 lg:w-1/2 lg:pr-20">
                    <p className="text-[#13213C] text-xs md:text-sm lg:text-[15px] uppercase font-medium tracking-widest">{t('section')}</p>
                    <h2 className={`${rajdhani.className} text-[#13213C] font-bold text-[31px] md:text-[38px] lg:text-[46px]`}>{t('title')}</h2>
                </div>
                <div className="flex flex-col gap-4 lg:w-1/2 ">
                    <p className="text-[#535353] text-sm md:text-[15px] lg:text-[16px] md:mb-5 lg:mb-10">{t('text-2')}</p>
                    {/* <div className="h-[5px] w-[60px] md:w-[80px] lg:w-[100px] bg-[#ff9302]"></div> */}

                    <div className="flex ">
                        <p className="text-[#13213C] font-semibold tracking-wider text-base  uppercase">{t('click')}</p>
