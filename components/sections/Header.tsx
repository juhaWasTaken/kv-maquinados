                ...
                <div className="text-white max-w-[652px] m-5">
                    ...
                    <BoxReveal boxColor={"#ff9302"} duration={0.5}>
                        <div className="flex flex-col sm:flex-row gap-5 min-w-full text-center sm:text-start sm:w-fit">
                            <Link href="/contact" className={`bg-[#ff9302] flex items-center text-lg text-white py-2 px-6 hover:bg-[#13213C] hover:text-[#ff9302] transition-colors duration-300 ${rajdhani.className}`}>{t('header.button-1')}</Link>
                            <Link href="/portfolio" className={`bg-transparent border-[2px] text-lg border-[#ff9302] text-white py-2 px-6 hover:bg-white hover:border-white hover:text-[#ff9302] transition-colors duration-300 ${rajdhani.className}`}>{t('header.button-2')}</Link>
                        </div>
                    </BoxReveal>
                </div>
            </div>
