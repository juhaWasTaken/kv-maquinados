...
export function HeaderAbout() {
    ...
    return (
        <section className="relative h-[620px] md:h-[364px] bg-cover bg-center bg-aboutHeader mb-20">
            ...
            <div className='relative z-10 flex flex-col items-center justify-center max-w-[1280px] h-full mx-auto text-center gap-3'>
                <h1 className={`${rajdhani.className} text-white text-[37px] md:text-[47px] lg:text-[58px]`}>{t('about:title')}</h1>
