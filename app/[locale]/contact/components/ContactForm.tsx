            ...
            <div className="max-w-[1280px] mx-auto flex flex-col lg:flex-row">
                <form onSubmit={handleSubmit(onSubmit)} className="p-6 md:p-11 lg:p-12 bg-white m-4 lg:w-[50%]">
                    <h2 className={`${rajdhani.className} text-[31px] md:text-[38px] lg:text-[46px] mb-3 text-[#13213C]`}>
                        {t('contact:title')}<span className="text-[#ff9302]">.</span>
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                        <div className="flex flex-col">
                            <label className={`${rajdhani.className} text-base md:text-[1.063rem] lg:text-lg`}>{t('contact:form.name')}</label>
                            <input
                                {...register('name')}
                        ...
                        <div className="flex flex-col">
                            <label className={`${rajdhani.className} text-base md:text-[1.063rem] lg:text-lg`}>{t('contact:form.email')}</label>
                            <input
                                {...register('email')}
                                className="bg-[#f5f5f5] px-4 py-2"
                                type="email"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                        <div className="flex flex-col">
                            <label className={`${rajdhani.className} text-base md:text-[1.063rem] lg:text-lg`}>{t('contact:form.subject')}</label>
                            <input
                                {...register('subject')}
                                className="bg-[#f5f5f5] px-4 py-2"
                                type="text"
                        ...
                        <div className="flex flex-col">
                            <label className={`${rajdhani.className} text-base md:text-[1.063rem] lg:text-lg`}>{t('contact:form.phone')}</label>
                            <input
                                {...register('phone')}
                                className="bg-[#f5f5f5] px-4 py-2"
                                type="text"
                    ...
                    <div className="flex flex-col mb-3">
                        <label className={`${rajdhani.className} text-base md:text-[1.063rem] lg:text-lg`}>{t('contact:form.message')}</label>
                        <textarea
                            {...register('message')}
                            className="bg-[#f5f5f5] px-4 py-2"
                            rows={5}
